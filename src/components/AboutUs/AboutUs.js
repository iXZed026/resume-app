...
export const AboutUs = () => {
  ...
  const [aboutUs, setAboutUs] = useState([
    ...
    // { id: 3, firstName: "سارا", lastName: "مرادخانی", yearOfBirth: 1381, area: "Database", aboutMe: "بنده ومن هستم برای کار در اشپز خانه و شستین ظرفا با سال ها تجربه", img: "../images/sara.png", expertise: 'دانشجو', address: "فردیس,شهرک 110,گلستان 14غربی,هنر یکم غربی", gender: 'زن' },
    {
      ...
      - هشت ماه فعالیت حرفه ای در حوزه طراحی و ادمین سایت با وردپرس
      - مسلط به پنل وردپرس و کار با انواع قالب ها از جمله وودمارت
      - مسلط به صفحه ساز المنتور، المنتور پرو و ویژوال کامپوزر
      - مسلط به طراحی ریسپانسیو
      - مسلط به افزونه های پر کاربرد از جمله ووکامرس، جت انجین، وردفنس، راکت، یوآست سئو، داپلیکیتور و...
      - مسلط به طراحی و راه اندازی صفر تا صد فروشگاه آنلاین با استفاده از وردپرس و ووکامرس
      - راه اندازی درگاه پرداخت برای فروشگاه‌های آنلاین با استفاده از پلاگین های درگاه پرداخت
      - ایجاد و سفارشی‌سازی قالب‌های وردپرس
      - پیاده‌سازی اینماد در فروشگاه‌های آنلاین در وردپرس
      - نصب و پیکربندی افزونه‌ها و پوسته‌های وردپرس
      - مسلط به سی پنل و دایرکت ادمین
      - آشنایی با نرم افزار گرافیکی ادوبی فتوشاپ
      - آشنایی با مفاهیم SEO و ابزار سرچ کنسول
      - آشنایی با پایه های فرانت اند (HTML, CSS)
      توانمندی های دیگر:
      - توانایی کار گروهی و همکاری با تیم‌های توسعه وب
      - مهارت‌های خوب ارتباطی و ارائه
      - توانایی حل مشکلات و پیدا کردن راه حل‌های نوآورانه
      - علاقه‌مندی به پیشرفت و یادگیری مستمر در حوزه توسعه وب`, img: "../images/ashkan.png", expertise: 'دانشجو', address: "فردیس,شهرک 110,گلستان 14غربی,هنر یکم غربی", gender: 'مرد'
    },
  ]);
    ...
    <>
      {
        !moreInfo ? (
          ...
          <MoreInfo {...newAboutUs} setMoreInfo={setMoreInfo} />
        )
      }
    </>
  )
